...
const J1page = ({ gameData }: Props) => {
  ...
  const isDisabled = useMemo(
    () => c2 === Move.Null || isLoading || isTxnPending,
    [c2, isLoading, isTxnPending]
  );
      ...
      <div className="flex flex-col gap-4 items-center py-2">
        {c2 == Move.Null ? (
          hasJ2TimedOut(gameData) ? (
            <div className="text-neutral"> Opponent Timed out!</div>
          ) : (
          ...
          <div className="flex flex-col-reverse gap-3 md:flex-col items-center">
            ...
            <MoveIcon moveType={Move[c2]} extendClass="btn-disabled" />
            {!isRevealed && (
