...
const J2page = ({ gameData }: Props) => {
  ...
  const isDisabled = useMemo(
    () =>
      ...
      isTxnPending,
    [isLoading, selectedMove, isTxnPending]
  );
  ...
  return (
    <div className="w-full flex flex-col gap-4 md:flex-row items-center justify-start md:justify-between">
      <div className="flex flex-col gap-4 items-center border-b border-black md:border-none py-2">
        {c2 === Move.Null ? (
          hasJ2TimedOut(gameData) ? (
            <div className="text-neutral"> You Timed Out !</div>
          ) : (
            // select move form
            <form
          ...
          <>
            ...
            <MoveIcon
              moveType={Move[c2]}
              extendClass=" bg-primary-content btn-disabled hover:bg-primary-content"
            />
          </>
        )}
      </div>
      ...
      <div className="flex flex-col gap-4 items-center py-2">
        {c2 == Move.Null ? (
          ...
          <div className="text-neutral text-center">
            Opponent has played his move. <br /> Play yours now
          </div>
        ) : c1 === Move.Null ? (
          ...
          <div className="flex flex-col-reverse md:flex-col items-center gap-1">
            ...
            <MoveIcon moveType={Move[c1]} extendClass="btn-disabled" />
          </div>
        )}
      </div>
    </div>
